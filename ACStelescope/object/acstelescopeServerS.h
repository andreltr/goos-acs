...
#ifndef _TAO_IDL____OBJECT_ACSTELESCOPESERVERS_H_
#define _TAO_IDL____OBJECT_ACSTELESCOPESERVERS_H_
...
namespace POA_acstelescopeServer
{
  ...
  public:
    ...
    typedef ::acstelescopeServer::TelescopeServer _stub_type;
    typedef ::acstelescopeServer::TelescopeServer_ptr _stub_ptr_type;
    typedef ::acstelescopeServer::TelescopeServer_var _stub_var_type;
    
    TelescopeServer (const TelescopeServer& rhs);
    ...
    ::acstelescopeServer::TelescopeServer *_this (void);
    ...
    static void startTelescope_skel (
        TAO_ServerRequest & server_request,
        void * servant_upcall,
        void * servant
      );
    ...
    static void slewTelescope_skel (
        TAO_ServerRequest & server_request,
        void * servant_upcall,
        void * servant
      );
    ...
    static void _get_currentPositionAlpha_skel (
        TAO_ServerRequest & server_request,
        void * servant_upcall,
        void * servant
      );
    ...
    static void _get_currentPositionDelta_skel (
        TAO_ServerRequest & server_request,
        void * servant_upcall,
        void * servant
      );
