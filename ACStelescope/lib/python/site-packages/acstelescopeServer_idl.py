...
class _objref_TelescopeServer (_0_ACS._objref_CharacteristicComponent):
    ...
    __methods__ = ["displayMessage", "badMethod", "startTelescope", "slewTelescope", "_get_currentPositionAlpha", "_get_currentPositionDelta"] + _0_ACS._objref_CharacteristicComponent.__methods__
...
class TelescopeServer (_0_ACS__POA.CharacteristicComponent):
    ...
    _omni_op_d = {"displayMessage": _0_acstelescopeServer.TelescopeServer._d_displayMessage, "badMethod": _0_acstelescopeServer.TelescopeServer._d_badMethod, "startTelescope": _0_acstelescopeServer.TelescopeServer._d_startTelescope, "slewTelescope": _0_acstelescopeServer.TelescopeServer._d_slewTelescope, "_get_currentPositionAlpha": _0_acstelescopeServer.TelescopeServer._d__get_currentPositionAlpha, "_get_currentPositionDelta": _0_acstelescopeServer.TelescopeServer._d__get_currentPositionDelta}
