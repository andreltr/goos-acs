...
TelescopeServer._d_slewTelescope = ((), (omniORB.tcInternal.tv_double, ), None)
...
class _objref_TelescopeServer (_0_ACS._objref_CharacteristicComponent):
    ...
    def startTelescope(self, *args):
        return _omnipy.invoke(self, "startTelescope", _0_acstelescopeServer.TelescopeServer._d_startTelescope, args)

    def slewTelescope(self, *args):
        return _omnipy.invoke(self, "slewTelescope", _0_acstelescopeServer.TelescopeServer._d_slewTelescope, args)

    def getAltitude(self, *args):
        return _omnipy.invoke(self, "getAltitude", _0_acstelescopeServer.TelescopeServer._d_getAltitude, args)
    ...
    __methods__ = ["displayMessage", "badMethod", "startTelescope", "slewTelescope", "getAltitude", "getAzimuth", "stopSlewing", "_get_currentPositionAlpha", "_get_currentPositionDelta"] + _0_ACS._objref_CharacteristicComponent.__methods__
