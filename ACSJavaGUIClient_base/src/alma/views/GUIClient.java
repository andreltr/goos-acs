...
import alma.utils.gCCDFileSelectorDialog;
import alma.utils.gCCDImagePanel;
...
public class GUIClient extends javax.swing.JFrame {
	...
	public void modelPropertyChange(PropertyChangeEvent evt) {
		...
		if (evt.getPropertyName().equals(Controller.COMP_CURRENT_STATE)) {
			Integer newIntegerValue = (Integer) evt.getNewValue();

			if (!jLabelCCDInfoCameaSt.getText().equals(newIntegerValue)) {
				/*
				 * switch (newIntegerValue) { case 0:
				 * jLabelCCDInfoCameaSt.setText("Off");
				 * jLabelCCDInfoCameaSt.setText("Off");
				 * 
				 * ccdOn = false; coolerOn = false; acquiring = false; break;
				 * case 1: jLabelCCDInfoCameaSt.setText("On");
				 * jLabelCCDInfoCoolerSt.setText("Off"); ccdOn = true; coolerOn
				 * = false; acquiring = false; break; case 2:
				 * jLabelCCDInfoCameaSt.setText("Acquiring"); acquiring = true;
				 * break; case 3: jLabelCCDInfoCameaSt.setText("On");
				 * jLabelCCDInfoCoolerSt.setText("On"); ccdOn = true; coolerOn =
				 * true; acquiring = false; break; }
				 */
			}
		}

		else if (evt.getPropertyName().equals(Controller.COMP_CAMERA_MODELS)) {
			String[] newStringValue = (String[]) evt.getNewValue();
			jComboBoxCCDModels
					.setModel(new DefaultComboBoxModel(newStringValue));
		} else if (evt.getPropertyName().equals(
				Controller.COMP_COMMANDED_CCD_TEMP)) {
