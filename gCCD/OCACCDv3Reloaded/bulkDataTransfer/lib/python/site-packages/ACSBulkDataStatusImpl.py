...
class BaseException:
    ...
    pass
######################################################################
class AVCbErrorExImpl(ACSBulkDataStatus.AVCbErrorEx, ACSError, BaseException):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
    def __init__(self,
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Receiver callback error"
        description = self.shortDescription
        ACSError.__init__(self,  
                          ACSErr.ACSBulkDataStatus,
                          ACSBulkDataStatus.AVCbError,
                          exception,
                          description,
                          nvSeq,                          
                          create,
                          severity)
        ACSBulkDataStatus.AVCbErrorEx.__init__(self, self.errorTrace)
        return
    #--------------------------------------------------------------------------        
    def getACSBulkDataStatusEx(self):
        '''
        Returns this exception converted into an ACSBulkDataStatusEx
        '''
        return ACSBulkDataStatus.ACSBulkDataStatusEx(self.getErrorTrace())


######################################################################
class AVCbErrorCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
...
######################################################################
class AVCbReadyCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
	...
	Provide this to extract previous error trace information and put this into
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Receiver callback ok status"
        description = self.shortDescription
        ACSError.__init__(self,
                          ACSErr.ACSBulkDataStatus,
                          ACSBulkDataStatus.AVCbReady,
                          exception,
                          description,
                          nvSeq,
                          create,
...
######################################################################
class AVCbWorkingCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
	...
	Provide this to extract previous error trace information and put this into
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Receiver callback working status"
        description = self.shortDescription
        ACSError.__init__(self,
                          ACSErr.ACSBulkDataStatus,
                          ACSBulkDataStatus.AVCbWorking,
                          exception,
                          description,
                          nvSeq,
                          create,
...
######################################################################
class AVCbTimeoutCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
	...
	Provide this to extract previous error trace information and put this into
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Receiver callback timeout status"
        description = self.shortDescription
        ACSError.__init__(self,
                          ACSErr.ACSBulkDataStatus,
                          ACSBulkDataStatus.AVCbTimeout,
                          exception,
                          description,
                          nvSeq,
                          create,
...
######################################################################
class AVCbWorkingTimeoutCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
	...
	Provide this to extract previous error trace information and put this into
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Receiver callback timeout and working status"
        description = self.shortDescription
        ACSError.__init__(self,
                          ACSErr.ACSBulkDataStatus,
                          ACSBulkDataStatus.AVCbWorkingTimeout,
                          exception,
                          description,
                          nvSeq,
                          create,
...
######################################################################
class AVCbNotAvailableCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
	...
	Provide this to extract previous error trace information and put this into
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Receiver callback not available"
        description = self.shortDescription
        ACSError.__init__(self,
                          ACSErr.ACSBulkDataStatus,
                          ACSBulkDataStatus.AVCbNotAvailable,
                          exception,
                          description,
                          nvSeq,
                          create,
...
if __name__ == "__main__":
    ...
    try:
        raise AVCbErrorExImpl
    except ACSBulkDataStatus.AVCbErrorEx, e:
        print "Caught the correct type of exception:", e
        g = AVCbErrorExImpl(exception=e)
        g.Print()
    except Exception, e:
        print "Caught the wrong type of exception:", e


    joe = AVCbReadyCompletionImpl()
    joe.Print()


    joe = AVCbWorkingCompletionImpl()
    joe.Print()


    joe = AVCbTimeoutCompletionImpl()
    joe.Print()


    joe = AVCbWorkingTimeoutCompletionImpl()
    joe.Print()


    joe = AVCbNotAvailableCompletionImpl()
    joe.Print()


    joe = AVCbErrorCompletionImpl()
    joe.Print()
