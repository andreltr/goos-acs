...
import alma.model.AbstractModel;
...
public abstract class AbstractController implements PropertyChangeListener {
	...
	private ArrayList<GUIClient> registeredViews;
	private ArrayList<AbstractModel> registeredModels;

	/** Creates a new instance of Controller */
	public AbstractController() {
		registeredViews = new ArrayList<GUIClient>();
	 ...
	 */
	public void addView(GUIClient view) {
	 ...
	 */
	public void removeView(GUIClient view) {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		for (GUIClient view : registeredViews) {
