...
* This class makes up the core of both the standalone and applet versions
* of the browser. You may embed this component in some other tool which 
* needs to display or edit the contents of a FITS file.
***************************************************************************/
...
/**************************************************************************
* Set the password provider to be used when reading an encrypted data stream
* By default this class uses a {@link eap.filter.PopupPasswordProvider}.
**************************************************************************/
...
public void load(File file) throws IOException {
    ...
    if(filters.hasFilter(file.getName()) ){
        /*************************************************
        * we need to filter the data and that
        * means using an InputStream as the data source
        ************************************************/
    ...
    /***********************************************************
    * Either there wasn't any filtering to do, or the data
    * didn't meet the filters expectations. In either case we
    * are reading the raw data, so we might as well do that with a
    * random access FITS file, since that's better for FITS I/O
    ***********************************************************/
    load( new RandomAccessFitsFile(
