...
class _objref_TelescopeServer (_0_ACS._objref_CharacteristicComponent):
    ...
    def slewTelescopeNorth(self, *args):
        return _omnipy.invoke(self, "slewTelescopeNorth", _0_acstelescopeServer.TelescopeServer._d_slewTelescopeNorth, args)

    def slewTelescopeSouth(self, *args):
        return _omnipy.invoke(self, "slewTelescopeSouth", _0_acstelescopeServer.TelescopeServer._d_slewTelescopeSouth, args)

    def slewTelescopeWest(self, *args):
        return _omnipy.invoke(self, "slewTelescopeWest", _0_acstelescopeServer.TelescopeServer._d_slewTelescopeWest, args)

    def slewTelescopeEast(self, *args):
        return _omnipy.invoke(self, "slewTelescopeEast", _0_acstelescopeServer.TelescopeServer._d_slewTelescopeEast, args)
